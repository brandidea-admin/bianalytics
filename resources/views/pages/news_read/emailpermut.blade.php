                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="search_name" name="search_name" class="form-control form-control-sm" placeholder="Enter Search Name" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="tag_name" name="tag_name" class="form-control form-control-sm" placeholder="Enter Tag Name" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="key_exclude" name="key_exclude" class="form-control form-control-sm" placeholder="Enter Keyword Exclude" required>
                        </div>
