...
$json  = file_get_contents("C:\/xampp\htdocs\lead_generation_backend\permut\/sourceinfo.json");

//Decode JSON
$json_data = json_decode($json,true);

//Print data
// print_r($json_data["sources"]);
// exit;

foreach ($json_data["sources"] as $value) {
...
$catgy = array_unique($categ);
$langa = array_unique($lang);
$country = array_unique($contry);
...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add News Read</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 stretch-card"> 
        <div class="card">
            <form action="{{url('/news_read')}}" method="POST" role="search">
                <div class="card-header">
                    <h4 class="mb-3 mb-md-0">Add News Read</h4>
                </div>
                <div class="card-body">
                    @csrf
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="newsread_name" name="newsread_name" class="form-control form-control-sm" placeholder="Enter News Search Name" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="news_type" name="news_type" class="form-control form-control-sm js-example-basic-single">
                                ...
                                <option selected value="TopHeadlines">Top Headlines</option>
