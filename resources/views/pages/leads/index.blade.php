                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="#" class="btn btn-sm btn-warning btn-icon-text alldone" data-toggle="tooltip" data-placement="bottom" title="Generate Email IDs">
                                            <i class="fas fa-check text-white"></i>
                                        </a>
                                    @endif
                                   
                                    @if($slist->email_req_id != "" && $slist->emails == "Generated")
                                    ...
                                    @else
                                        <a href="#" class="btn btn-sm btn-warning btn-icon-text check-generate" data-toggle="tooltip" data-placement="bottom" title="Validate Email IDs">
                                        <i class="fas fa-envelope text-blue"></i>
                                        </a>
                                    @endif
...
<script>
    $(function() {
        ...
        $('.alldone').click(function() {
            alert("Sorry, Email Permutation Already Generated !!!");
            $('#psdatasourcSpinner').hide();
            return false;
        });

        $('.check-generate').click(function() {
            alert("Unable to validate email ids OR Already emails validated !!!");
            $('#psdatasourcSpinner').hide();
            return false;
        });
        ...
        $(document).on('click', '#viewnews', function() {
            ...
            $.ajax({
                type: 'POST',
                url: '/leadhunter/public/lead/' + leadid + '/viewnews',
                data: tottxt2,
                complete: function() {
                    $('#psdatasourcSpinner').hide();
                },
