...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Edit Email Permutation</li>
    </ol>
</nav>
...
<div class="row">
    <div class="col-md-12 stretch-card"> 
        <div class="card">
            <form action="{{url('/email_permut', $posts['id'])}}" method="POST" role="search">
                @method('PUT')
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="search_name">Edit Email Permuation Name
                            ...
                            <input type="text" id="emailpermut_name" name="emailpermut_name" class="form-control form-control-sm" placeholder="Enter Email Permuation Name" value="{{$posts['emailpermut_name']}}" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="	first_name" name="first_name" class="form-control form-control-sm" placeholder="Enter First Name" value="{{$posts['first_name']}}" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="last_name" name="last_name" class="form-control form-control-sm" placeholder="Enter Last Name" value="{{$posts['last_name']}}" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="nick_name" name="nick_name" class="form-control form-control-sm" placeholder="Enter Nick Name" value="{{$posts['nick_name']}}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="middle_name" name="middle_name" class="form-control form-control-sm" placeholder="Enter Middle Name" value="{{$posts['middle_name']}}">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="domain_name" name="domain_name" class="form-control form-control-sm" placeholder="Enter Domain Name" value="{{$posts['domain_name']}}" required>
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" id="comments" name="comments" class="form-control form-control-sm" placeholder="Comments" value="{{$posts['comments']}}">
                        </div>
