...
{    
  ...
  // console.log("map",overlay);
	...
	if(file =="KML/1--21--21.kml" || file =="KML/1--21--1.kml")
	{
...
function backcircle()
{
	...
	if(backfile=="KML/1---21---21.kml" || backfile=="KML/1---21---1.kml")
	{
...
//loc_type1(mainloc,subloc,fileid);
   ...
   loc_type1(mainloc,subloc,fileid);
	...
	if(mainloc=='10'&& subloct=='13')
	{
	mast="village";

	}
	// else if(mainloc=='13'&& subloct=='14')
	// {
	// mast="village_master";
	// }
	...
	strokeColor: colorcodeid1[circleid1[i]],
	strokeOpacity:0.7,
	strokeWeight: 2,
	fillColor:colorcodeid1[circleid1[i]],
	fillOpacity:v,
	map: map,
	...
	if(svgpath=="KML/1---21---21.kml" || svgpath=="KML/1---21---1.kml")
	{

	file1=svgpath.split("KML/");
	file2=file1[1].split(".kml");
	file3=file2[0].split("---");
	fileid1=file3[0];
	mainloc1=file3[1];
